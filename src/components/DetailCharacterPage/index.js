            ...
            {loading ? (
                ...
                <div className="wrapper-detail">
                    <div className="detail-character">
                        ...
                        />
                        <div>
                            <h2 className="detail-character__name">
                                {character.name}
                            </h2>
                            <p className="detail-character__house">
                                <span className="detail-character--bold">
                                    Casa: 
                                </span>{' '}
                                {character.house ? character.house : 'Sin casa'}
                            </p>
                            <p className="detail-character__birth">
                                <span className="detail-character--bold">
                                    Nacimiento:
                                </span>{' '}
                            ...
                            <p className="detail-character__patronus">
                                <span className="detail-character--bold">
                                    Patronus:
                                </span>{' '}
                                {character.patronus ? character.patronus : '-'}
                            </p>
                            <p className="detail-character__alive">
                                <span className="detail-character--bold">
                                    Estado:
                                </span>{' '}
                                {character.alive ? 'Vivo' : '☠️'}
                            </p>
                        </div>
                    </div>
